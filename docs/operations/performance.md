...
| 32+ GB dedicated | `8`–`10` | 100 K+ torrents/day | Power-user / multi-tenant scale |
...
From a quality-evidence pass on a single 32 GB / 8 vCPU host running at `DHT_SCALING_FACTOR=10`:
